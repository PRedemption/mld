          ...
          >
            ...
            >
              <h1 className='mb-5 md:text-5xl text-3xl font-bold text-green-700'>
                ...
                ZimConnect The International Calling App For You
              </h1>
              <div className='text-xl font-semibold tracking-tight mb-5 text-gray-500'>
                More than 41% of the global population lacks dependable internet
                access, with underserved communities bearing the brunt of this
                disparity. Consequently, they are unable to utilize free calling
                services to maintain connectivity. Our mission is to close this
                gap and facilitate connection!.
              </div>
              <div className='mb-4 space-x-0 md:space-x-2 md:mb-8'>
                <Link
                  to='/contact'
                  className='text-white bg-green-700 hover:bg-green-700 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0'
                >
                  Learn more
                  <svg
